...
if("TRUE" STREQUAL "TRUE")
  set(moveit_tutorials_SOURCE_PREFIX /home/yao/ws_moveit/src/moveit_tutorials)
  set(moveit_tutorials_DEVEL_PREFIX /home/yao/ws_moveit/devel/.private/moveit_tutorials)
  ...
  set(moveit_tutorials_INSTALL_PREFIX /home/yao/ws_moveit/install)
...
if(NOT "/home/yao/ws_moveit/src/moveit_tutorials/doc/interactivity/include;/usr/include/eigen3 " STREQUAL " ")
  set(moveit_tutorials_INCLUDE_DIRS "")
  set(_include_dirs "/home/yao/ws_moveit/src/moveit_tutorials/doc/interactivity/include;/usr/include/eigen3")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'moveit_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yao/ws_moveit/src/moveit_tutorials/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT moveit_tutorials_NUM_DUMMY_TARGETS)
      set(moveit_tutorials_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::moveit_tutorials::wrapped-linker-option${moveit_tutorials_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR moveit_tutorials_NUM_DUMMY_TARGETS "${moveit_tutorials_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::moveit_tutorials::wrapped-linker-option${moveit_tutorials_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND moveit_tutorials_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/yao/ws_moveit/devel/.private/moveit_tutorials/lib;/home/yao/ws_moveit/devel/lib;/opt/ros/kinetic/lib)
